...
const EmployerClient = ({ currentUser, employer, reviews, isAilable, rating }: {currentUser: UserProps, employer: EmployerProps, reviews: ReviewProps[], isAilable: boolean | null, rating: number | null}) => {
